...
//        notifyDataSetChanged()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SnowViewHolder {
        ...
        val binding: ItemSnowBinding =
            ItemSnowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        //뷰홀더에 던져주기
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val snowHolder = holder as SnowViewHolder
        snowHolder.bind(snowList[position])
    }
    ...
    class SnowViewHolder(private val binding: ItemSnowBinding) :
